...
// gsutil cors set cors.json gs://pdf-buddy-7dbaf.appspot.com
// go here >>> https://console.cloud.google.com/
// create new file in editor calls cors.json
// run >>> // gsutil cors set cors.json gs://pdf-buddy-7dbaf.appspot.com
...
function PdfView({ url }: { url: string }) {
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            {!file ? (
                <Loader2Icon className="animate-spin  h-20 w20 mt-20 text-indigo-600" />
            ) : (
                <Document
                    loading={null}
                    file={file}
