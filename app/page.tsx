...
const features = [
  ...
  },
  {
    ...
    description: "Access and chat with your PDFs seamlessly on ant device, whether It's your desktop, tablet, or smartphone.",
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Introducing{" "}
              <span className="font-bold text-indigo-600">PDF Buddy</span>
              <br />
